...
namespace LibFreeVPN.Providers.SocksHttp
{
    ...
    public sealed class ShIo : VPNProviderHttpGetBase<ShIo.Parser>
    {
        public sealed class Parser : SocksHttpWithOvpnParserTea<Parser>
        {
            ...
            protected override string OuterKey => Encoding.ASCII.FromBase64String("YVolUlUlaXRSTUJeOCZVZQ==");
        }
        ...
        protected override string RequestUri => Encoding.ASCII.FromBase64String("aHR0cHM6Ly9pb3Zwbi5tZS9hcHAvY29uZmlnL2hkaGRoZGRkZC5waHA=");
    }
}
